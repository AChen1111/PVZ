...
void load_game_resources() {
	...
	loadimage(&img_gravestone_left, _T("resources/gravestone.png"));

	flip_image(&img_gravestone_left,&img_gravestone_right);
	...
	loadimage(&img_peashooter_selector_background_left, _T("resources/peashooter_selector_background.png"));

	flip_image(&img_peashooter_selector_background_right, &img_peashooter_selector_background_left);



	loadimage(&img_sunflower_selector_background_left, _T("resources/sunflower_selector_background.png"));
